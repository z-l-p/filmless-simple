...
color BACKGROUND = color(180);  //the color that will fill the entire frame where there's no image (clear 255 is best for production)
int GUIDELINE_PX = 16;        // The pixel width of the vertical guidelines between strips of film (set to 0 to disable)
int SHOW_PAGENUM = 0;            // Set to true to print page numbers (leave it off for printing the template)
